  ...
  return (
    <main className="max-w-md mx-auto px-4 py-10">
      ...
      <Card>
        ...
        <input aria-label="Email" placeholder="your@email.com" className="mt-1 w-full rounded-xl border border-neutral-300 px-3 py-2" value={email} onChange={e=>setEmail(e.target.value)} />
